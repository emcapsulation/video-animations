...
class BubbleSort(Scene):
    def construct(self):
        ...
        title_text = Text("Bubble Sort", font_size=48).shift(UP*2) 
        ...
        s.bubble_sort(self, run_time=0.8)
...
class SelectionSortExplanation(Scene):
    def construct(self):
        Text.set_default(font="Monospace")
...
class InsertionSortExplanation(Scene):
    def construct(self):
        Text.set_default(font="Monospace")

        title_text = Text("Insertion Sort", font_size=48).shift(UP*2) 
        title_group = VGroup(title_text)
        ...
        s.insertion_sort(self, run_time=0.8)
        self.wait(1)
